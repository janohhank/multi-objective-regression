...
class TrainingParameters:
    ...
    multi_objective_functions: dict[str, float]
    ...
    def from_json(json_str: str) -> "TrainingParameters":
        ...
        return TrainingParameters(
            ...
            morse=(
                MorseParameters.from_dict(**data["morse"]) if "morse" in data else None
            ),
            deap=DeapParameters.from_dict(**data["deap"]) if "deap" in data else None,
